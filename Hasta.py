...
class Hasta:
    def __init__(self, hasta_no, ad, soyad, dogum_tarihi, hastalik, tedavi):
        # Private değişkenler tanımlanıyor
    ...
    def tedavi_suresi_hesapla(self):
        # Örneğin, basit bir hesaplama yöntemi
        return len(self.__tedavi) * 2  # Tedavi uzunluğuna göre süre hesaplama

    # Hasta bilgilerini döndüren özel __str__ metodu
    def __str__(self):
